...
def load_mhlw_shisetsu(file_bytes: bytes) -> pd.DataFrame:
    ...
    staff_kw = [
        ...
        ("常勤_看護師",                "常勤看護師数"),
        ("常勤看護師",                 "常勤看護師数"),
        # 施設全体_* 優先、次に 常勤_*、最後に単純キーワード
        ("施設全体_理学療法士_常勤",  "常勤理学療法士数"),
        ("常勤_理学療法士",            "常勤理学療法士数"),
        ("理学療法士_常勤",            "常勤理学療法士数"),
        ("常勤理学療法士",             "常勤理学療法士数"),
        ("施設全体_作業療法士_常勤",  "常勤作業療法士数"),
        ("常勤_作業療法士",            "常勤作業療法士数"),
        ("作業療法士_常勤",            "常勤作業療法士数"),
        ("常勤作業療法士",             "常勤作業療法士数"),
        ("施設全体_言語聴覚士_常勤",  "常勤言語聴覚士数"),
        ("常勤_言語聴覚士",            "常勤言語聴覚士数"),
        ("言語聴覚士_常勤",            "常勤言語聴覚士数"),
        ("常勤言語聴覚士",             "常勤言語聴覚士数"),
        ("施設全体_薬剤師_常勤",      "常勤薬剤師数"),
        ...
        ("薬剤師_常勤",                "常勤薬剤師数"),
        ("常勤薬剤師",                 "常勤薬剤師数"),
        ("施設全体_診療放射線技師_常勤", "常勤診療放射線技師数"),
        ("常勤_診療放射線技師",        "常勤診療放射線技師数"),
        ("診療放射線技師_常勤",        "常勤診療放射線技師数"),
        ("常勤診療放射線技師",         "常勤診療放射線技師数"),
        ("施設全体_臨床検査技師_常勤", "常勤臨床検査技師数"),
        ("常勤_臨床検査技師",          "常勤臨床検査技師数"),
        ("臨床検査技師_常勤",          "常勤臨床検査技師数"),
        ("常勤臨床検査技師",           "常勤臨床検査技師数"),
        # ── 非常勤 ──
        ...
        ("医師_非常勤",                  "非常勤医師数"),
        ("非常勤医師",                   "非常勤医師数"),
        ("施設全体_看護師_非常勤",      "非常勤看護師数"),
        ("非常勤_看護師",                "非常勤看護師数"),
        ("看護師_非常勤",                "非常勤看護師数"),
        ("非常勤看護師",                 "非常勤看護師数"),
        ("施設全体_理学療法士_非常勤",  "非常勤理学療法士数"),
        ("非常勤_理学療法士",            "非常勤理学療法士数"),
        ("理学療法士_非常勤",            "非常勤理学療法士数"),
        ("非常勤理学療法士",             "非常勤理学療法士数"),
        ("施設全体_作業療法士_非常勤",  "非常勤作業療法士数"),
        ("非常勤_作業療法士",            "非常勤作業療法士数"),
        ("作業療法士_非常勤",            "非常勤作業療法士数"),
        ("非常勤作業療法士",             "非常勤作業療法士数"),
        ("施設全体_言語聴覚士_非常勤",  "非常勤言語聴覚士数"),
        ("非常勤_言語聴覚士",            "非常勤言語聴覚士数"),
        ("言語聴覚士_非常勤",            "非常勤言語聴覚士数"),
        ("非常勤言語聴覚士",             "非常勤言語聴覚士数"),
        ("施設全体_薬剤師_非常勤",      "非常勤薬剤師数"),
        ("非常勤_薬剤師",                "非常勤薬剤師数"),
        ("薬剤師_非常勤",                "非常勤薬剤師数"),
        ("非常勤薬剤師",                 "非常勤薬剤師数"),
        ("施設全体_診療放射線技師_非常勤", "非常勤診療放射線技師数"),
        ("非常勤_診療放射線技師",        "非常勤診療放射線技師数"),
        ("診療放射線技師_非常勤",        "非常勤診療放射線技師数"),
        ("非常勤診療放射線技師",         "非常勤診療放射線技師数"),
        ("施設全体_臨床検査技師_非常勤", "非常勤臨床検査技師数"),
        ("非常勤_臨床検査技師",          "非常勤臨床検査技師数"),
        ("臨床検査技師_非常勤",          "非常勤臨床検査技師数"),
        ("非常勤臨床検査技師",           "非常勤臨床検査技師数"),
        ("救急車の受入件数",           "救急搬送件数"),
        ("救急搬送",                   "救急搬送件数"),
    ]
